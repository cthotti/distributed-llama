...
ifndef TERMUX_VERSION
	CXXFLAGS += -march=armv8.2-a+dotprod+fp16 -mtune=cortex-a76 -O3 -ffast-math -funroll-loops -fprefetch-loop-arrays -fno-stack-protector
endif
...
ifeq ($(OS),Windows_NT)
	...
	DEPS += nn-vulkan.o vk-mem-alloc.o
endif
...
vk-mem-alloc.o: src/nn/vk_mem_alloc.cpp
	$(CXX) $(CXXFLAGS) -c $^ -o $@
